...
class SAMUI_CORE_API KeyEvent : public Event
{
  public:
...
class SAMUI_CORE_API KeyPressedEvent : public KeyEvent
{
  public:
...
class SAMUI_CORE_API KeyReleasedEvent : public KeyEvent
{
  public:
...
class SAMUI_CORE_API KeyTypedEvent : public KeyEvent
{
  public:
