...
namespace samui
{
enum class SAMUI_RENDERING_API CullFaceType
{
    Front,
    Back,
    FrontAndBack
...
enum class SAMUI_RENDERING_API FaceVertexOrder
{
    Clockwise,
    CounterClockwise
};

enum class SAMUI_RENDERING_API PolygonMode
{
    Wireframe,
    Fill
};
...
class SAMUI_RENDERING_API RenderingAPI
{
  public:
